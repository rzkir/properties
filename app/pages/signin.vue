<template>
  <main
    class="min-h-[calc(100vh-80px)] flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8 bg-[#FBFBF9]"
  >
    <div
    ...
    >
      ...
      <div class="text-center">
        ...
        <p class="mt-3 text-sm text-gray-500">
          Silakan masuk ke akun Anda untuk melanjutkan pencarian properti
          syariah idaman.
        </p>
      </div>
      ...
      <form class="mt-8 space-y-6" @submit.prevent="onSubmit">
        <div class="space-y-5">
          <!-- Email -->
          <div class="space-y-2">
            <UiLabel for="email" class="text-gray-700"> Alamat Email </UiLabel>
            <div class="relative">
              <div
          ...
          <!-- Password -->
          <div class="space-y-2">
            <UiLabel for="password" class="text-gray-700"> Kata Sandi </UiLabel>
            <div class="relative">
              <div
                class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"
              >
        ...
        <div class="flex items-center justify-between text-xs sm:text-sm">
          <label class="flex items-center cursor-pointer select-none gap-2">
            ...
            />
            <span class="block text-gray-600"> Ingat saya </span>
          </label>
        ...
        <div class="pt-1">
          <UiButton
            ...
            type="submit"
            variant="default"
            class="group text-white relative w-full justify-center text-sm font-bold rounded-full bg-emerald-syariah hover:bg-emerald-800 shadow-lg shadow-emerald-900/20 transition-colors py-6 cursor-pointer"
            :disabled="loading"
          >
            <Icon
              v-if="loading"
