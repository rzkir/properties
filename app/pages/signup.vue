  ...
  >
    <div class="w-full max-w-xl md:max-w-2xl space-y-20">
      ...
      <div class="text-center">
        <h1
          class="text-3xl sm:text-4xl font-bold text-emerald-syariah mb-4 leading-tight"
        >
      ...
      >
          ...
          <div class="flex items-start gap-3 px-1">
            ...
            <p class="text-xs leading-5 text-gray-500">
              <label for="terms" class="cursor-pointer">
                ...
                <NuxtLink
                  to="#"
                  class="text-emerald-syariah font-bold hover:underline"
                >
                  Syarat &amp; Ketentuan
                </NuxtLink>
                serta
        ...
        <div class="pt-6 text-center text-sm font-medium">
          ...
          <NuxtLink
            to="/signin"
            class="text-emerald-syariah font-bold hover:underline ml-1"
          >
            Masuk di sini
          </NuxtLink>
        </div>
