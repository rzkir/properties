  ...
  <div class="space-y-8">
    <!-- Edit Profil -->
          <section id="edit-profile">
            ...
            <div class="bg-white p-6 md:p-8 rounded-4xl border border-gray-100 shadow-soft">
              <form class="grid grid-cols-1 md:grid-cols-2 gap-6" @submit.prevent="saveProfile">
                ...
                <div class="md:col-span-2 space-y-2">
                  ...
                  <div class="flex items-center gap-6">
                    ...
                    <div class="min-w-0">
                      ...
                      <p v-else-if="profileErrors.photoURL" class="text-xs text-red-500 font-medium mt-1">{{ profileErrors.photoURL }}</p>
                    </div>
                  </div>
                </div>
                <div class="space-y-2">
                  <UiLabel for="displayName" class="text-xs font-bold text-gray-400 uppercase tracking-widest">Nama Lengkap</UiLabel>
                  <div class="relative">
                  ...
                  <p v-if="profileErrors.displayName" class="text-xs text-red-500 font-medium">{{ profileErrors.displayName }}</p>
                </div>
                <div class="space-y-2">
                  <UiLabel for="email" class="text-xs font-bold text-gray-400 uppercase tracking-widest">Alamat Email</UiLabel>
                  <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-emerald-syariah">
                    ...
                    <UiInput
                      ...
                      type="email"
                      class="w-full pl-12 pr-4 py-3 bg-gray-50 border rounded-xl text-sm font-medium focus:ring-2 focus:ring-emerald-800/20 focus:border-emerald-500 outline-none transition-all"
                      :class="profileErrors.email ? 'border-red-300' : 'border-gray-100'"
                      :readonly="!!user?.email"
                    />
                  </div>
                ...
                <div class="space-y-2">
                  <UiLabel for="phoneNumber" class="text-xs font-bold text-gray-400 uppercase tracking-widest">Nomor WhatsApp</UiLabel>
                  <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-emerald-syariah">
                  ...
                  <p v-if="profileErrors.phoneNumber" class="text-xs text-red-500 font-medium">{{ profileErrors.phoneNumber }}</p>
                </div>
                <div class="space-y-2">
                  <UiLabel for="areaDomisili" class="text-xs font-bold text-gray-400 uppercase tracking-widest">Area Domisili</UiLabel>
                  <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-emerald-syariah">
                  ...
                  <p v-if="profileErrors.areaDomisili" class="text-xs text-red-500 font-medium">{{ profileErrors.areaDomisili }}</p>
                </div>
          ...
          <section id="change-password">
            ...
            <div class="bg-white p-6 md:p-8 rounded-4xl border border-gray-100 shadow-soft">
              <form class="max-w-md space-y-6" @submit.prevent="updatePassword">
                <div class="space-y-2">
                  <UiLabel for="password-current" class="text-xs font-bold text-gray-400 uppercase tracking-widest">Sandi Lama</UiLabel>
                  <UiInput
                    id="password-current"
                ...
                <div class="space-y-2">
                  <UiLabel for="password-new" class="text-xs font-bold text-gray-400 uppercase tracking-widest">Sandi Baru</UiLabel>
                  <UiInput
                    id="password-new"
                ...
                <div class="space-y-2">
                  <UiLabel for="password-confirm" class="text-xs font-bold text-gray-400 uppercase tracking-widest">Konfirmasi Sandi Baru</UiLabel>
                  <UiInput
                    id="password-confirm"
              ...
              <div>
                ...
                <div class="bg-white p-6 rounded-4xl border border-gray-100 shadow-soft">
                  <div class="flex items-center justify-between mb-6">
                    <div>
                      ...
                      <p class="text-[11px] text-gray-400">
                        Status:
                        <span :class="twoFaEnabled ? 'text-green-600 font-bold uppercase' : 'text-red-500 font-bold uppercase'">
                  ...
                  <div class="p-4 bg-gray-50 rounded-2xl flex items-center gap-4">
                    <div class="w-16 h-16 bg-white border-2 border-dashed border-gray-200 rounded-lg flex items-center justify-center shrink-0">
          ...
          <section id="privacy">
            ...
            <div class="bg-white p-6 md:p-8 rounded-4xl border border-gray-100 shadow-soft">
              <div class="space-y-4">
                ...
                <label class="flex items-start gap-4 p-4 rounded-2xl hover:bg-gray-50 transition-colors cursor-pointer">
                  <input
                    v-model="privacy.tampilkanAktivitas"
                    type="checkbox"
                    class="w-5 h-5 mt-0.5 rounded border-gray-300 text-emerald-syariah focus:ring-emerald-syariah"
                  />
                  <div>
          ...
          <section id="danger-zone" class="pt-8">
            <div class="bg-red-50 border border-red-100 rounded-4xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
              <div class="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p class="text-sm text-red-600/80 max-w-md">
                    Tindakan ini tidak dapat dibatalkan. Seluruh riwayat booking dan wishlist Anda akan dihapus dari sistem kami secara permanen.
                  </p>
                </div>
              </div>
              <button
