<template>
  <div class="space-y-8">
    ...
    <section id="edit-profile">
      ...
      <div
        class="bg-white p-6 md:p-8 rounded-4xl border border-gray-100 shadow-soft"
      >
        <form
        ...
        >
          ...
          <div class="md:col-span-2 space-y-2">
            ...
            <div class="flex items-center gap-6">
              <div class="relative shrink-0">
                ...
                >
                  <img
                    v-if="form.photoURL && !photoLoadError"
                    :src="form.photoURL"
                    alt="Foto profil"
              ...
              <div class="min-w-0">
                <p class="text-sm font-medium text-gray-700">
                  Unggah foto profil (JPG, PNG, WebP, GIF, max 5MB)
                </p>
                <p
                  v-if="uploadingPhoto"
                  class="text-xs text-emerald-syariah font-medium mt-1"
                >
                  Mengunggah...
                </p>
                <p
                  v-else-if="profileErrors.photoURL"
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              <div
                class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-emerald-syariah"
              >
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <UiInput
                ...
                class="w-full pl-12 pr-4 py-3 bg-gray-50 border rounded-xl text-sm font-medium focus:ring-2 focus:ring-emerald-800/20 focus:border-emerald-500 outline-none transition-all"
                :class="
                  profileErrors.email ? 'border-red-300' : 'border-gray-100'
                "
                :readonly="!!user?.email"
              />
            </div>
            ...
            <p v-else-if="user?.email" class="text-[10px] text-gray-400">
          ...
          <div class="space-y-2">
            ...
            <p
              v-if="profileErrors.phoneNumber"
              class="text-xs text-red-500 font-medium"
            >
              {{ profileErrors.phoneNumber }}
            </p>
          ...
          <div class="space-y-2">
            ...
            <p
              v-if="profileErrors.areaDomisili"
              class="text-xs text-red-500 font-medium"
            >
              {{ profileErrors.areaDomisili }}
            </p>
        ...
        <form class="max-w-md space-y-6" @submit.prevent="updatePassword">
          <div class="space-y-2">
            ...
            <UiInput
              ...
              :class="
                passwordErrors.current ? 'border-red-300' : 'border-gray-100'
              "
            />
            <p
          ...
          <div class="space-y-2">
            ...
            <UiInput
              ...
              class="w-full px-4 py-3 bg-gray-50 border rounded-xl text-sm font-medium focus:ring-2 focus:ring-emerald-800/20 outline-none transition-all"
              :class="
                passwordErrors.confirm ? 'border-red-300' : 'border-gray-100'
              "
            />
            <p
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <section id="notifications" class="space-y-6">
        <div>
          <div class="flex items-center gap-4 mb-4">
            <div
              class="w-8 h-8 bg-emerald-50 rounded-lg flex items-center justify-center text-emerald-syariah"
            >
              <Icon name="lucide:bell" />
            </div>
            <h3 class="text-xl font-bold text-emerald-syariah">
              Notifikasi Email
            </h3>
          </div>
          <div
            class="bg-white p-6 rounded-4xl border border-gray-100 shadow-soft space-y-5"
          >
            <div class="flex items-center justify-between">
              <div class="pr-4">
                <p class="text-sm font-bold text-gray-800">
                  Update Properti Baru
                </p>
                <p class="text-[11px] text-gray-400">
                  Info unit terbaru sesuai preferensi Anda
                </p>
              </div>
            ...
            <div class="flex items-center justify-between">
              <div class="pr-4">
                ...
                <p class="text-[11px] text-gray-400">
                  Penawaran khusus dan diskon akad
                </p>
              </div>
              <label class="toggle-switch">
            ...
            <div class="flex items-center justify-between">
              <div class="pr-4">
                ...
                <p class="text-[11px] text-gray-400">
                  Notifikasi chat dari agen properti
                </p>
              </div>
              <label class="toggle-switch">
      ...
      <section id="security" class="space-y-6">
        <div>
          ...
          <div
            class="bg-white p-6 rounded-4xl border border-gray-100 shadow-soft"
          >
            ...
            <div class="p-4 bg-gray-50 rounded-2xl flex items-center gap-4">
              ...
              <p class="text-xs text-gray-500">
                Scan QR code menggunakan Google Authenticator untuk
                mengaktifkan.
              </p>
            </div>
          </div>
    ...
    <section id="privacy">
      ...
      >
        <div class="space-y-4">
          <label
            class="flex items-start gap-4 p-4 rounded-2xl hover:bg-gray-50 transition-colors cursor-pointer"
          >
            <input
            ...
            <div>
              ...
              <p class="text-xs text-gray-400">
                Izinkan developer melihat profil dasar Anda saat melakukan
                booking
              </p>
            </div>
          </label>
    ...
    <section id="danger-zone" class="pt-8">
      ...
      >
        <div class="flex items-center gap-6">
          <div
            class="w-16 h-16 bg-red-100 rounded-2xl flex items-center justify-center text-red-600 shrink-0"
          >
          ...
          <div>
            ...
            <p class="text-sm text-red-600/80 max-w-md">
              Tindakan ini tidak dapat dibatalkan. Seluruh riwayat booking dan
              wishlist Anda akan dihapus dari sistem kami secara permanen.
            </p>
          </div>
        </div>
        <button
