<template>
  <div class="space-y-6">
    ...
    <SectionHeader
      ...
      description="Kelola badge-badge properti yang tersedia di sistem"
      icon="lucide:award"
      :badge="loading ? undefined : `${badges.length} badge`"
      :loading="loading"
      :stats="
              ...
              <TableCell colspan="4" class="text-center py-12">
                <div class="flex flex-col items-center justify-center gap-2">
                  ...
                  <p class="text-xs text-muted-foreground/80">
                    Klik "Tambah Badge" untuk menambahkan data baru
                  </p>
                </div>
              </TableCell>
            </TableRow>
...
import { useBadgesState } from "@/services/useStateProperties";
import SectionHeader from "@/components/dashboard/SectionHeader.vue";
import BadgesModal from "@/components/dashboard/badges/BadgesModal.vue";
import BadgesDeleteModal from "@/components/dashboard/badges/BadgesDeleteModal.vue";
