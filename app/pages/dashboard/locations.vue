<template>
  <div class="space-y-6">
    ...
    <SectionHeader
      ...
      description="Kelola lokasi-lokasi properti yang tersedia di sistem"
      icon="lucide:map-pin"
      :badge="loading ? undefined : `${locations.length} lokasi`"
      :loading="loading"
      :stats="
              ...
              <TableCell colspan="4" class="text-center py-12">
                <div class="flex flex-col items-center justify-center gap-2">
                  ...
                  <p class="text-xs text-muted-foreground/80">
                    Klik "Tambah Lokasi" untuk menambahkan data baru
                  </p>
                </div>
              </TableCell>
            </TableRow>
...
import { useLocationsState } from "@/services/useStateProperties";
import SectionHeader from "@/components/dashboard/SectionHeader.vue";
import LocationsModal from "@/components/dashboard/locations/LocationsModal.vue";
import LocationsDeleteModal from "@/components/dashboard/locations/LocationsDeleteModal.vue";
